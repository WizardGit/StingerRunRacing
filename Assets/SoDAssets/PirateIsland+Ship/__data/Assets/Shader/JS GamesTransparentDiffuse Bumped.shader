Shader "JS Games/Transparent/Diffuse Bumped" {
	Properties {
			...
			Program "fp" {
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat1.xy = u_xlat0.xy * vec2(_BumpIntensity);
					    u_xlat0.x = min(u_xlat4, 1.0);
					    u_xlat0.x = (-u_xlat0.x) + 1.0;
					    u_xlat1.z = sqrt(u_xlat0.x);
					    u_xlat0.x = dot(vs_TEXCOORD1.xyz, u_xlat1.xyz);
					    u_xlat0.y = dot(vs_TEXCOORD2.xyz, u_xlat1.xyz);
					    u_xlat0.z = dot(vs_TEXCOORD3.xyz, u_xlat1.xyz);
