Shader "Shader Forge/FX_Fog" {
	Properties {
		_Color ("Color", Vector) = (0.5,0.5,0.5,1)
		_MainTex ("Main Tex", 2D) = "white" {}
		_USpeedMain ("U Speed Main", Float) = 0
		_VSpeedMain ("V Speed Main", Float) = 0
		_SecondaryTex ("Secondary Tex", 2D) = "white" {}
		_USpeedSecondary ("U Speed Secondary", Float) = 0
		_VSpeedSecondary ("V Speed Secondary", Float) = 0
	}
	SubShader {
		Tags { "IGNOREPROJECTOR" = "true" "QUEUE" = "Transparent+100" "RenderType" = "Transparent" }
		Pass {
			Name "FORWARD"
			Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Transparent+100" "RenderType" = "Transparent" "SHADOWSUPPORT" = "true" }
			...
			Program "fp" {
				SubProgram "d3d11 hw_tier00 " {
					...
					layout(std140) uniform PGlobals {
						...
						float _VSpeedMain;
						vec4 _MainTex_ST;
						vec4 _SecondaryTex_ST;
						float _VSpeedSecondary;
						float _USpeedSecondary;
						vec4 _Color;
					};
					...
					void main()
					{
					    ...
					    u_xlat2.xy = vec2(_USpeedMain, _VSpeedMain) * u_xlat0.xx + vs_TEXCOORD0.xy;
					    u_xlat0.xw = vec2(_USpeedSecondary, _VSpeedSecondary) * u_xlat0.xx + vs_TEXCOORD0.xy;
					    u_xlat0.xw = u_xlat0.xw * _SecondaryTex_ST.xy + _SecondaryTex_ST.zw;
					    u_xlat1 = texture(_SecondaryTex, u_xlat0.xw);
