Shader "JS Games/Transparent/Diffuse Panner" {
	Properties {
		_MainTex ("Base (RGB) Trans (A)", 2D) = "white" {}
		_ScrollXSpeed ("X Scroll Speed", Range(-40, 40)) = 2
		_ScrollYSpeed ("Y Scroll Speed", Range(-40, 40)) = 2
	}
	SubShader {
		LOD 200
			...
			Program "fp" {
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat2.xy = vec2(_ScrollXSpeed, _ScrollYSpeed) * _Time.xx + vs_TEXCOORD0.xy;
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat1.xy = vec2(_ScrollXSpeed, _ScrollYSpeed) * _Time.xx + vs_TEXCOORD0.xy;
	...
	Fallback "JS Games/Transparent/Vertex Lit"
}